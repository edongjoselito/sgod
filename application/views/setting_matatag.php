                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row->matatag; ?></td>
                                                    <td>
                                                        <a data-toggle="modal" data-field="<?= $row->matatag; ?>" data-id="<?= $row->id; ?>" class="open-AddBookDialog text-primary" href="#app_edit"><i class="mdi mdi-file-document-box-check-outline"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label ><?= $label; ?></label>
                                                            <input type="text"  name="matatag" class="form-control" />
                                                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group col-md-12">
                                                            <label><?= $label; ?></label>
                                                            <input type="text"  id="field" name="matatag" class="form-control" value="" />
                                                        </div>
