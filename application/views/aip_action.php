                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php if(in_array($this->session->section, ['System Administrator', 'CID Admin'], true)){ ?>
                                            ...
                                            <?php }else{ ?>
                                                <input type="hidden" name="action" value="Re-submit"  class="form-control" >
                                            <?php } ?>
                                            <div class="row">
                                                            <input type="hidden" name="submit_id" value="<?= $this->uri->segment('3'); ?>"  class="form-control" >
