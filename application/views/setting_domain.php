                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row->domain; ?></td>
                                                    <td>
                                                        <a data-toggle="modal" data-field="<?= $row->domain; ?>" data-id="<?= $row->id; ?>" class="open-AddBookDialog text-primary" href="#app_edit"><i class="mdi mdi-file-document-box-check-outline"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group col-md-12">
                                                            <label><?= $label; ?></label>
                                                            <input type="text"  id="field" name="domain" class="form-control" value="" />
                                                        </div>
