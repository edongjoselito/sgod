                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row->strand; ?></td>
                                                    <td>
                                                        <a data-toggle="modal" data-field="<?= $row->strand; ?>" data-id="<?= $row->id; ?>" class="open-AddBookDialog text-primary" href="#app_edit"><i class="mdi mdi-file-document-box-check-outline"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label><?= $label; ?></label>
                                                            <input type="text"  id="field" name="strand" class="form-control" value="" />
                                                        </div>
