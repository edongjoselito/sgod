...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (schoolHeadContactRow) {
		...
		var designationField = form.querySelector('[name="adminDesignation"]').closest('.form-group');
		var designationRow = designationField.closest('.form-row');
        var schoolHeadEmail = profileInput('School Head Email', 'adminEmail', 'email');
		mobileField.className = telephoneField.className = schoolHeadEmail.className = designationField.className = 'form-group col-md-3';
		schoolHeadContactRow.insertBefore(designationField, mobileField);
        schoolHeadContactRow.appendChild(schoolHeadEmail);
		if (!designationRow.children.length) designationRow.remove();
    }
