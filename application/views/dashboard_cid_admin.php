...
<html lang="en">
    ...
    <head>
        ...
        <style>
            :root {
                ...
                --cid-muted: #7b7fa7;
                --cid-surface: #ffffff;
                --cid-border: rgba(60, 64, 198, 0.12);
                --cid-shadow: 0 24px 60px rgba(15, 23, 42, 0.08);
            }
    ...
    <body>
        ...
        <?php
            $identifier = strtoupper(trim((string) ($this->session->userdata('identifier') ?: $this->session->userdata('secGroup') ?: 'CID')));
            $sectionsCount = (int) $data1->num_rows();
            $usersCount = (int) $data->num_rows();

            $quickLinks = [
                [
                    'href' => base_url() . 'Page/memo',
                    'label' => 'Open Memos',
                    'meta' => 'Post and track CID memoranda by group.',
                    'icon' => 'mdi mdi-file-document-edit-outline',
                ],
                [
                    'href' => base_url() . 'Page/usersList',
                    'label' => 'Manage Users',
                    'meta' => 'Create and maintain CID user accounts.',
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    <div class="container-fluid cid-dashboard">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-7 mb-4">
                                <div class="panel-card">
                                    ...
                                    <h4 class="panel-title">Jump straight into daily CID work</h4>
                                    <p class="panel-copy">
                                        Open the most-used admin areas without digging through the menu. These shortcuts keep the
                                        page practical while the dashboard stays focused on CID-only data.
                                    </p>
                            ...
                            <div class="col-xl-5 mb-4">
                                <div class="panel-card">
                                    <div class="panel-kicker">CID Snapshot</div>
                                    ...
                                    <p class="panel-copy">
                                        ...
                                        early and keep CID records neatly separated from OSDS and SGOD.
                                    </p>
                                    <ul class="scope-list">
