(function ($) {
    ...
    function renderObjective(kraIndex, objectiveIndex, objective) {
        ...
        html += '<a class="objective-accomplishment-link" href="' + escapeHtml(accUrl) + '" target="_blank" title="View encoded accomplishments">Accomplishments <span class="badge badge-soft-primary">' + accCount + '</span></a>';
        if (isFull()) {
